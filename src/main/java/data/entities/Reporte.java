...
public class Reporte implements Serializable {
    ...
    public Reporte(Timestamp date, Double latitude, Double longitude, List<String> picturesURLs, String comment, Usuario usuario, Animal animal, Set<Respuesta> respuestas) {
        this.date = date;
